...
export function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-64 glass border-r border-dm-border z-40 flex flex-col">
      {/* Logo */}
      <div className="px-6 py-6 border-b border-dm-border">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-dm-primary/20 border border-dm-primary/30 flex items-center justify-center">
      ...
      {/* Footer */}
      <div className="px-6 py-4 border-t border-dm-border">
        <div className="flex items-center gap-2">
          <div className="live-dot" />
          <span className="text-[10px] text-dm-muted-foreground uppercase tracking-wider font-medium">
            Sistema activo
          </span>
        </div>
        <p className="text-[10px] text-dm-muted-foreground/60 mt-2">
